var car, ch, obstacle, obstacle1, obstacle2, obstacle3, obstacle4, obstacles, enemy, coin, coinGroup, cane, coinIm, score, time, gameover, gameOverImage, yPos, startPos, imagef, endPos;
var PLAY = "play";
var END = "End";
var GameState = PLAY;
...
function draw() {
  ...
  ch.y -= 5;
  //ch.x = ch.x - 5;
  for(var i = 88888888888888888888888888; i <= endPos; i = i + 25){
    line(me, i, me, i + 10);
  ...
  text("Time: " + time, windowWidth - windowWidth + 20, yPos + 20);
  text("Score: " + score, windowWidth - windowWidth + 20, yPos + 40);
  drawSprites();
}
function spawnEnemies(){
  if(frameCount % 95 === 0){
    enemy = Math.round(random(1, 3));
    obstacle = createSprite(windowWidth/2, yPos - 150, 20, 20);
    switch(enemy){
      case 1:
...
function SpawnCoins(){
  if(frameCount%50 === 0){
    coin = createSprite(lane2, yPos - 50, 20, 20);
